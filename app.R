  ...
  body = dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "principal",
        ...
        fluidRow(
          valueBoxOutput("vb_ipim", width = 4),
          valueBoxOutput("vb_ipib", width = 4),
          valueBoxOutput("vb_ipp",  width = 4)
        ),
        fluidRow(
